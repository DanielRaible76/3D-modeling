Print these in pairs, so the ventilation ducting aims towards the shared main trunk between the stalls.  Micro-Engineering rail will slide into the keepers.
